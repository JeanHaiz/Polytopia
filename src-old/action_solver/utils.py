...
def setDeltaMoves(turn, delta_moves):
    model.Add(dic[turn + "_" + 'delta_moves'] == delta_moves)
...
def buildDictionnaries(turn, stars, moves):
...
def addInitialState(turn, stars, moves):
    if turn == "start":
        ...
        if moves:
            model.Add(dic['start_delta_moves'] == 0)
            model.Add(dic['start_move_move'] == 0)
            model.Add(dic['start_move_training'] == 0)
            model.Add(dic['start_move_attack'] == 0)
            model.Add(dic['start_move_knight_chain'] == 0)
            model.Add(dic['start_move_tech_purchase'] == 0)
            model.Add(dic['start_move_road_building'] == 0)
            model.Add(dic['start_move_population'] == 0)
            model.Add(dic['start_move_city_upgrade'] == 0)
            model.Add(dic['start_move_city_capture'] == 0)
            model.Add(dic["start_move_rider_bump"] == 0)

        if stars:
            model.Add(dic[turn + "_" + "stars"] == 3)
    ...
    if turn == "t0":
        model.Add(dic["t0_ruin"] == 0)


def addSolution(turn):
    model.Add(dic["t0_population"] == 2)
    model.Add(dic["t1_warrior"] == 2)
    model.Add(dic["t1_revealed"] == 30)
...
def chooseBestSolution(df, stars, moves):
    if stars:
